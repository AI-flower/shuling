...
>
> 设计与实施细则：[`docs/plans/v3.2-creator-business-intelligence-plan.md`](docs/plans/v3.2-creator-business-intelligence-plan.md)
>
...
- 选题价值闸门（goal_alignment + monetization_distance + benchmark + asset 五维评分）
- 标题公式系统（8 类 × 24 个自有抽象公式 + intent）
- 草稿五维诊断 + AI 味检测（clarity / title_cover_fit / expression_efficiency / cognitive_gap / human_signal / business_alignment）
- 业务归因型复盘（traffic / save / trust / lead / sales / controversy 多信号 + main_attribution）
- 创作者执行摩擦诊断（planning_loop / direction_hopping / draft_no_publish 等行为信号）
...
- 00-routing 增加业务画像 / 概念预检 / 行为信号检查分支
