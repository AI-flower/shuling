...
本仓库当前使用 **Business Source License 1.1 (BSL 1.1)**，不是 OSI 批准的开源许可证。

- 个人非商业使用：允许
- 公司 / 组织 / 商业主体使用：需要另行取得 AI-flower 的商业许可
- 自动切换日期：`2030-04-23`
- 切换后的许可证：`Apache-2.0`

安全披露、漏洞修复讨论和 issue/PR 协作不受此说明影响，但仓库代码的使用权限以 [LICENSE](LICENSE) 为准。
